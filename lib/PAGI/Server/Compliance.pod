...
C<websocket.http.response> denial, and the C<sse.http.response.*> decline.
...
C<sse.start>, or contradict the guaranteed close that follows an SSE
decline or WebSocket denial. Each stripped occurrence, not deduplicated
by name, logs C<PAGI: connection-specific header '$name' stripped from
HTTP/1.1 response>.

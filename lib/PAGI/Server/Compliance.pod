...
HTTP/1.1 is unaffected: C<Connection> and C<Transfer-Encoding> are
ordinary, meaningful HTTP/1.1 response headers there, so no HTTP/1.1
response path performs this strip.

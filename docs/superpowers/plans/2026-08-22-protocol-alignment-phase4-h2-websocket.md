...
| 2. Per-stream keepalive | complete (review clean; reviewer re-ran set; 5 stop sites traced) | 4652bdc, ab5778e | +4 subtests, h1 parity in t/04 / 26 tests | /tmp/phase4-task2-final.out (Files=6, Tests=26, PASS; -pass.out is an interim 5-file run) |
